---
layout: post
title: Deploy a Kubernetes cluster for free, using k3s and Oracle Cloud always free resources.
description: Deploy a high available kubernetes cluster for free on Oracle Cloud Infrastructure (OCI), using OCI always free resources, k3s (lightweight kubernetes), Terraform and Longhorn to provide persistent storage...
...
You can clone [this](https://github.com/garutilorenzo/k3s-oci-cluster) repository and work in the *example/* directory. You have to edit the *main.tf* file and you have to create the *terraform.tfvars* file. For more detail see [Oracle provider setup](#oracle-provider-setup) and [Pre flight checklist](#pre-flight-checklist).
...
![k3s-infra]({{ site.baseurl }}/images/k3s-oci-always-free.drawio.png)
...
![k3s-wp-install]({{ site.baseurl }}/images/k3s-wp.png)
